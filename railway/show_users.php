...
";
    ...
    echo " <br><a href=\"http://localhost/railway/new_user_form.html\" style='font-size:20px; color:white; background:blue; text-align:center; border-radius:10px;'> Add New User </a><br> ";
    echo " <br><a href=\"http://localhost/railway/admin_login.php\" style='font-size:20px; color:white; background:blue; text-align:center; border-radius:10px;'>Go Back to Admin Menu!!!</a> ";
    ?>
</body>
